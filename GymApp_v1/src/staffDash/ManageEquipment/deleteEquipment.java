...
public class deleteEquipment extends javax.swing.JFrame{
    ...
    public deleteEquipment() {
        ...
        tableDarkWithDelete1.configureForTable(
            ...
            "id",      // Actual ID column name in database
    ...
    private void initComponents() {
        ...
        bg.add(UserLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 160, -1, -1));
        ...
        UserLabel10.setText("Remove Equipment");
        ...
        bg.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(42, 237, 1250, 540));
