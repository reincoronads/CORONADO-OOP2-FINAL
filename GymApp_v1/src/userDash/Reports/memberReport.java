...
public class memberReport extends javax.swing.JFrame {
    ...
    public memberReport() {
        initComponents();
        String currentUserId = String.valueOf(Session.getInstance().getUid());
        showMemberReport(currentUserId);
    }
        ...
        try {
            ...
            try (ResultSet rs = dbc.getData(query)) {
                if (rs.next()) {
                    ...
                    // Set the report data
                    name.setText(rs.getString("user_Fname"));
                    status.setText(rs.getString("member_status"));
                    memID.setText(rs.getString("membership_id"));
                    start.setText(rs.getString("start_date"));
                    end.setText(rs.getString("end_date"));
                    ...
                    if (paymentAmount != null) {
                        ...
                        paymentLast.setText("$" + paymentAmount);
                        charge.setText("$" + paymentAmount);
                    } else {
                        paymentLast.setText("No payment recorded");
                        charge.setText("N/A");
                    }
