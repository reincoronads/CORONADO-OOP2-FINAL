...
import adminDash.Announcement.addAnnouncement;
import adminDash.Announcement.announcementTable;
import adminDash.Logs.activityLogs;
import adminDash.ManageEquipment.createEquipment;
import adminDash.ManageEquipment.deleteEquipment;
import adminDash.ManageEquipment.updateEquipTable;
import adminDash.ManageUser.deleteUser;
import adminDash.ManageUser.viewAllUser;
import adminDash.ManageEquipment.viewAllEquip;
import adminDash.ManageStaff.createStaff;
import adminDash.ManageStaff.deleteStaff;
import adminDash.ManageStaff.updateStaffTable;
import adminDash.ManageStaff.viewAllStaff;
import adminDash.ManageUser.createUser;
import adminDash.ManageUser.updateUserTable;
import adminDash.Membership.addMemberTable;
import adminDash.Membership.deleteMembership;
import adminDash.Membership.updateMemberTable;
import adminDash.Membership.viewAllMember;
import adminDash.Reports.memberTable;
import adminDash.Settings.Profile;
import config.dbConnector;
import textfield.HoverEffect;
...
import scroll.ScrollBarWin11UI;
...
public class main extends javax.swing.JFrame {
    ...
    public void showPieChart() {
        ...
        barChartPanel.setPreferredSize(new java.awt.Dimension(240, 190)); // Set preferred size

        // Clear and update panel
        panelBarChart.removeAll();
        panelBarChart.add(barChartPanel, BorderLayout.CENTER);
        panelBarChart.revalidate(); // Use revalidate() instead of validate()
        panelBarChart.repaint();    // Ensure repaint
    }
    ...
    private void initComponents() {
        ...
        ManageStaffPane = new javax.swing.JPanel();
        manageMemBtn1 = new javax.swing.JLabel();
        memIconWt2 = new javax.swing.JLabel();
        ...
        ManageMemPane1 = new javax.swing.JPanel();
        ...
        viewStaffPane = new textfield.RoundedPanel();
        viewIcon9 = new javax.swing.JLabel();
        UserLabel30 = new javax.swing.JLabel();
        DeleteStaffPane = new textfield.RoundedPanel();
        roundedPanel24 = new textfield.RoundedPanel();
        roundedPanel25 = new textfield.RoundedPanel();
        roundedPanel26 = new textfield.RoundedPanel();
        viewIcon10 = new javax.swing.JLabel();
        UserLabel31 = new javax.swing.JLabel();
        roundedPanel27 = new textfield.RoundedPanel();
        viewIcon11 = new javax.swing.JLabel();
        UserLabel32 = new javax.swing.JLabel();
        UpdateStaffPane = new textfield.RoundedPanel();
        roundedPanel28 = new textfield.RoundedPanel();
        roundedPanel29 = new textfield.RoundedPanel();
        roundedPanel30 = new textfield.RoundedPanel();
        viewIcon12 = new javax.swing.JLabel();
        UserLabel33 = new javax.swing.JLabel();
        AddStaffPane = new textfield.RoundedPanel();
        roundedPanel31 = new textfield.RoundedPanel();
        roundedPanel32 = new textfield.RoundedPanel();
        roundedPanel33 = new textfield.RoundedPanel();
        UserLabel34 = new javax.swing.JLabel();
        viewIcon14 = new javax.swing.JLabel();
        ...
        ManageStaffPane.setBackground(new java.awt.Color(0, 0, 0));
        ManageStaffPane.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ManageStaffPaneMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                ManageStaffPaneMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                ManageStaffPaneMouseExited(evt);
            }
        });
        ManageStaffPane.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        manageMemBtn1.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        manageMemBtn1.setForeground(new java.awt.Color(255, 255, 255));
        manageMemBtn1.setText("Staff Management");
        ManageStaffPane.add(manageMemBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(79, 10, 130, 30));

        memIconWt2.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        memIconWt2.setForeground(new java.awt.Color(255, 255, 255));
        memIconWt2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/staff-icon-small.png"))); // NOI18N
        ManageStaffPane.add(memIconWt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 30, 30));

        menu.add(ManageStaffPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 230, 40));
        ...
        menu.add(ManageEquipmentPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 230, 40));
        ...
        menu.add(membership, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 230, 40));
        ...
        menu.add(ReportsPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 230, 40));
        ...
        menu.add(ActivityLog, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 490, 230, 40));
        ...
        menu.add(settingPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 590, 230, 40));
        ...
        menu.add(announcementPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 540, 230, 40));
        ...
        StaffPane.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        ManageMemPane1.setBackground(new java.awt.Color(255, 255, 255));
        ManageMemPane1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        UserLabel25.setFont(new java.awt.Font("Century Gothic", 1, 36)); // NOI18N
        UserLabel25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/right-arrow.png"))); // NOI18N
        ManageMemPane1.add(UserLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, -1, -1));

        UserLabel26.setFont(new java.awt.Font("Century Gothic", 1, 36)); // NOI18N
        UserLabel26.setText("Manage Staff");
        ManageMemPane1.add(UserLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 70, -1, -1));

        UserLabel27.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        UserLabel27.setText("Manage Staff");
        ManageMemPane1.add(UserLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 160, 30));

        UserLabel28.setFont(new java.awt.Font("Century Gothic", 1, 36)); // NOI18N
        UserLabel28.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/home (1).png"))); // NOI18N
        ManageMemPane1.add(UserLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        UserLabel29.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        UserLabel29.setText("Home");
        ManageMemPane1.add(UserLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 16, 40, 20));

        viewStaffPane.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                viewStaffPaneMouseClicked(evt);
            }
        });
        viewStaffPane.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        viewIcon9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/view-all.png"))); // NOI18N
        viewStaffPane.add(viewIcon9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 130, -1));

        UserLabel30.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        UserLabel30.setText("VIEW STAFF");
        viewStaffPane.add(UserLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, -1, -1));

        ManageMemPane1.add(viewStaffPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 220, 210));

        DeleteStaffPane.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                DeleteStaffPaneMouseClicked(evt);
            }
        });
        DeleteStaffPane.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        roundedPanel24.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        DeleteStaffPane.add(roundedPanel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        roundedPanel25.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        roundedPanel26.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        roundedPanel25.add(roundedPanel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        DeleteStaffPane.add(roundedPanel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        viewIcon10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/delete-account.png"))); // NOI18N
        DeleteStaffPane.add(viewIcon10, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 130, -1));

        UserLabel31.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        UserLabel31.setText("DELETE STAFF");
        DeleteStaffPane.add(UserLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, -1, -1));

        ManageMemPane1.add(DeleteStaffPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 400, 220, 210));

        roundedPanel27.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        viewIcon11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/view-all.png"))); // NOI18N
        roundedPanel27.add(viewIcon11, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, 130, -1));

        UserLabel32.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        UserLabel32.setText("VIEW USER");
        roundedPanel27.add(UserLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, -1, -1));

        ManageMemPane1.add(roundedPanel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 220, 210));

        UpdateStaffPane.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                UpdateStaffPaneMouseClicked(evt);
            }
        });
        UpdateStaffPane.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        roundedPanel28.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        UpdateStaffPane.add(roundedPanel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        roundedPanel29.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        roundedPanel30.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        roundedPanel29.add(roundedPanel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        UpdateStaffPane.add(roundedPanel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        viewIcon12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/update-user.png"))); // NOI18N
        UpdateStaffPane.add(viewIcon12, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 200, 160));

        UserLabel33.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        UserLabel33.setText("UPDATE STAFF");
        UpdateStaffPane.add(UserLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 100, 30));

        ManageMemPane1.add(UpdateStaffPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        AddStaffPane.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                AddStaffPaneMouseClicked(evt);
            }
        });
        AddStaffPane.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        roundedPanel31.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        AddStaffPane.add(roundedPanel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        roundedPanel32.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        roundedPanel33.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        roundedPanel32.add(roundedPanel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        AddStaffPane.add(roundedPanel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 220, 210));

        UserLabel34.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        UserLabel34.setText("ADD STAFF");
        AddStaffPane.add(UserLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 160, -1, -1));

        viewIcon14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/staff-icon.png"))); // NOI18N
        AddStaffPane.add(viewIcon14, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 130, -1));

        ManageMemPane1.add(AddStaffPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 150, 220, 210));

        StaffPane.add(ManageMemPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1110, 890));

        TabPane.addTab("StaffPane", StaffPane);
        ...
        AddAnnouncement.add(viewIcon18, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 150, 140));
        ...
        SeeAnnouncement.add(viewIcon19, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 130, -1));
    ...
    private void ManageStaffPaneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ManageStaffPaneMouseClicked
        // TODO add your handling code here:
        TabPane.setSelectedIndex(2);
    }//GEN-LAST:event_ManageStaffPaneMouseClicked

    private void ManageStaffPaneMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ManageStaffPaneMouseEntered
        // TODO add your handling code here:
        JComponent comp = (JComponent) evt.getSource();
        comp.setBackground(new Color(80, 80, 90)); // Immediate color change
        comp.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
    }//GEN-LAST:event_ManageStaffPaneMouseEntered

    private void ManageStaffPaneMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ManageStaffPaneMouseExited
        // TODO add your handling code here:
        JComponent comp = (JComponent) evt.getSource();
        comp.setBackground(new Color(0, 0, 0));
        comp.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_ManageStaffPaneMouseExited
    ...
    private void viewStaffPaneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_viewStaffPaneMouseClicked
        // TODO add your handling code here:
        viewAllStaff view = new viewAllStaff();
        this.dispose();
        view.setVisible(true);
    }//GEN-LAST:event_viewStaffPaneMouseClicked

    private void DeleteStaffPaneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DeleteStaffPaneMouseClicked
        // TODO add your handling code here:
        deleteStaff view = new deleteStaff();
        this.dispose();
        view.setVisible(true);
    }//GEN-LAST:event_DeleteStaffPaneMouseClicked

    private void UpdateStaffPaneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UpdateStaffPaneMouseClicked
        // TODO add your handling code here:
        updateStaffTable view = new updateStaffTable();
        this.dispose();
        view.setVisible(true);
    }//GEN-LAST:event_UpdateStaffPaneMouseClicked

    private void AddStaffPaneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddStaffPaneMouseClicked
        // TODO add your handling code here:
        createStaff view = new createStaff();
        this.dispose();
        view.setVisible(true);
    }//GEN-LAST:event_AddStaffPaneMouseClicked
    ...
    private textfield.RoundedPanel AddStaffPane;
    ...
    private textfield.RoundedPanel DeleteStaffPane;
    ...
    private javax.swing.JPanel ManageMemPane1;
    private javax.swing.JPanel ManageStaffPane;
    ...
    private textfield.RoundedPanel UpdateStaffPane;
    ...
    private javax.swing.JLabel manageMemBtn1;
    ...
    private javax.swing.JLabel memIconWt2;
    ...
    private textfield.RoundedPanel roundedPanel24;
    private textfield.RoundedPanel roundedPanel25;
    private textfield.RoundedPanel roundedPanel26;
    private textfield.RoundedPanel roundedPanel27;
    private textfield.RoundedPanel roundedPanel28;
    private textfield.RoundedPanel roundedPanel29;
    private textfield.RoundedPanel roundedPanel30;
    private textfield.RoundedPanel roundedPanel31;
    private textfield.RoundedPanel roundedPanel32;
    private textfield.RoundedPanel roundedPanel33;
    ...
    private javax.swing.JLabel viewIcon10;
    private javax.swing.JLabel viewIcon11;
    private javax.swing.JLabel viewIcon12;
    private javax.swing.JLabel viewIcon13;
    private javax.swing.JLabel viewIcon14;
    ...
    private javax.swing.JLabel viewIcon9;
    private textfield.RoundedPanel viewStaffPane;
