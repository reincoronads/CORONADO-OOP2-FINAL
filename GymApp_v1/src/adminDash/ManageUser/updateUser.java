...
public class updateUser extends javax.swing.JFrame {
    ...
    // Updated isEmailDuplicate method to exclude current user
    private boolean isEmailDuplicate(String email, String currentUserId) {
        dbConnector dbc = new dbConnector();
        String query = "SELECT user_id FROM tbl_user WHERE user_Email = ? AND user_id != ?";
        try (Connection conn = dbc.getConnection();
            ...
            return true; // Assume duplicate to prevent data corruption
        }
    }
    ...
    private void initComponents() {
        ...
        pInfoPanel1.add(userType, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, 320, 60));
        ...
        pInfoPanel1.add(userStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 310, 320, 60));
        ...
        pInfoPanel1.add(userID, new org.netbeans.lib.awtextra.AbsoluteConstraints(107, 70, 310, 60));
        ...
        UserLabel10.setText("Update User");
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
      // Trim all inputs first
        ...
        String userTypeStr = (userType.getSelectedItem() != null) ? userType.getSelectedItem().toString() : "";
        String userStatusStr = (userStatus.getSelectedItem() != null) ? userStatus.getSelectedItem().toString() : "";

        // Validate required fields
        if (firstName.isEmpty() || lastName.isEmpty() || birthDate.isEmpty() || 
            phone.isEmpty() || userTypeStr.isEmpty() || email.isEmpty() || userStatusStr.isEmpty()) {
        ...
        if (isEmailDuplicate(email, userID.getText())) {
        ...
        try {
            ...
            pst.setString(5, userTypeStr);
            pst.setString(6, phone);
            pst.setString(7, userStatusStr);
            pst.setString(8, userID.getText().trim());

            int rowsUpdated = pst.executeUpdate();

            if (rowsUpdated > 0) {
                String activityDescription = "Updated User: " + fname.getText() + 
                                                   " " + lname.getText() + " ID: " +userID.getText();
    ...
    public void setParentTable(TableDarkWithEdit parentTable) {
