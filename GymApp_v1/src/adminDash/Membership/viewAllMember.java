...
public class viewAllMember extends javax.swing.JFrame {
  ...
  private void loadTableData() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewAllMember.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewAllMember().setVisible(true);
            }
        });
    }
